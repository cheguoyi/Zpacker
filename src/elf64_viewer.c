...
static bool	print_ehdr(check_safe_func_pointer safe)
{
...
static bool	print_phdr(check_safe_func_pointer safe, size_t offset)
{
...
static bool	print_shdr(check_safe_func_pointer safe, size_t offset)
{
